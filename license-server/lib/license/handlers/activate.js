...
const { kv }                                          = require('../../kv');
const { hashHwid, verifyCodeHmac, firmarToken }       = require('../../crypto');
const { checkAndIncrement, recordCodeFailure,
        clearCodeFailures, getIp }                    = require('../../ratelimit');
const { validateActivationInput, sendError, sendOk }  = require('../../validate');
